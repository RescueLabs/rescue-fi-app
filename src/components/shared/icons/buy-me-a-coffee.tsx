...
export const BuyMeACoffeeIcon: React.FC<React.SVGProps<SVGSVGElement>> = (
  props,
) => {
  return (
    <svg
    ...
    >
      ...
      <path
        className="st0"
        fill="currentColor"
        d="M393.4,160.9l-0.3,0.1L393.4,160.9z"
      />
      <path
        className="st0"
        fill="currentColor"
        d="M390.1,137.2C390.1,137.2,390.1,137.2,390.1,137.2C390,137.2,390,137.2,390.1,137.2
	C390.1,137.2,390.1,137.2,390.1,137.2z"
      ...
      <path
        className="st1"
        fill="#a366ff"
        d="M308,212.8c-11.8,5.1-25.3,10.8-42.7,10.8c-7.3,0-14.5-1-21.5-3l12,123.6c0.4,5.2,2.8,10,6.6,13.5
	...
	c-5.8-2-11.6-3.3-18.1-3.3C327.7,204.4,318.6,208.3,308,212.8z"
      ...
      <path
        className="st0"
        fill="currentColor"
        d="M412.8,148.7l-1.8-9.1c-1.6-8.2-5.3-16-13.7-18.9c-2.7-0.9-5.8-1.4-7.8-3.3c-2.1-2-2.7-5-3.2-7.8
